 ...
 */
export const getVitalsByPatientId = async (patientId: string): Promise<Record<string, unknown>> => {
 ...
 */
export const createVital = async (observation: Record<string, unknown>): Promise<Record<string, unknown>> => {
